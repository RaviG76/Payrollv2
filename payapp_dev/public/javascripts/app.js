...
payApp.controller('mainCtrl', function($scope, $http, $window,$location, $filter) {
    ...
    //var dateObject = new Date();//"31.01.2015";
    $scope.payroll_date = new Date("January 31, 2015");
    $scope.payroll_period = new Date("January 31, 2015");
    $scope.payroll_start = new Date("January 01, 2015");
    $scope.payroll_end = new Date("January 31, 2015");
