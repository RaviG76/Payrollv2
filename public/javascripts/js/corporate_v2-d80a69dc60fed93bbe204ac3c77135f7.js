        ...
        jQuery(function(t) {
            ...
            return t("body").ajaxSpinner(), n = 100, e = 25, s = 5, i = e + s * n, a = function(t) {
                ...
                sliderChanged: function(n, s) {
                    ...
                    return c = a(n), isNaN(n) ? void 0 : (o = "<div class='tooltip-header'></div>", o += "<div class='tooltip-content'>", o += "<h3>" + r(n) + "</h3>", o += "<ul>", c.totalCost >= i ? (h = t("#zen-slider-contact a").attr("href"), l = "Contactez-nous pour un tarif entreprise", o += "<li>" + l + "</li>", t("#pricing #total .total-text").html("<p class='text-large'>Pour les sociétés de plus de <span>100 personnes,</span><br /><span><a href='" + h + "'>contactez-nous</a></span> pour obtenir un tarif entreprise.</p>")) : (o += "<li>" + e + " &euro; tarif de base</li>", o += "<li>5 &euro; /personne x " + r(c.baseEmployees) + "</li>", t("#pricing #total .total-text").html("<p class='text-large'>Avec <span class='text-color'>" + r(n) + "</span> dans votre société, <br /><span>" + c.totalCost + " &euro; par mois</span> pour une paie moderne</p>")), o += "</ul>", o += "</div>", s(o))
                }
                ...
                sliderChanged: function(e, n) {
                    var s, o, l, c;
                    return l = a(e), isNaN(e) ? void 0 : (s = "<div class='tooltip-header'></div>", s += "<div class='tooltip-content'>", s += "<h3>" + r(e) + "</h3>", s += "<ul>", l.totalCost >= i ? (c = t("#zen-slider-contact a").attr("href"), o = "Contactez-nous pour un tarif entreprise", s += "<li>" + o + "</li>", t("#pricing #total .total-text").html("<div class='row'><div class='col-xs-6'><p>" + r(e) + "</p></div><div class='col-xs-6'><p><a href='" + c + "'>Contact us</a> for enterprise pricing</p></div></div>")) : s += "<li class='tooltip-price-total'><span class='total-cost'>$" + l.totalCost + "</span>/ month <span class='tooltip-payroll'>for delightful payroll</span></li>", s += "</ul>", s += "</div>", n(s))
                }
            })), o = function(t, e) {
