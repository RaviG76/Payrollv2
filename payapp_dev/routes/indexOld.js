...
var paypal = require('paypal-express-checkout').init('mss.naveensharma-facilitator_api1.gmail.com', '1403521583', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AGjelgIYjdIGjGvf2IUyW1bBDw3T', 'http://mastersoftwaretechnologies.com', 'http://mastersoftwaretechnologies.com', true);
...
router.post('/calculate', function(req, res, next) { 
    ...
    if(typeof base_sal != 'undefined' && typeof base_activity != 'undefined' && typeof base_dur != 'undefined') {
        ...
        var Rate_AV_P = (parseFloat(6.850)).toFixed(3), //Rate_Capped_pension_insurance
           Rate_AV_DP = (parseFloat(0.300)).toFixed(3),//Rate_Deplafonnee_pension_insurance
        Rate_ARRCO_T1 = (parseFloat(3.100)).toFixed(3),//Rate_Assoc_Reg_Complementary_Pensions_employees_T1
        Rate_ARRCO_T2 = (parseFloat(8.100)).toFixed(3),//Rate_Assoc_Reg_Complementary_Pensions_employees_T2
        Rate_ARRCO_TB = (parseFloat(7.800)).toFixed(3),//Rate_General_Association_of_Pension_Institutions_Frameworks_TB
        Rate_ARRCO_TC = (parseFloat(0.360)).toFixed(3),//Rate_General_Association_of_Pension_Institutions_Frameworks_TC
             Rate_CET = (parseFloat(0.130)).toFixed(3),//Rate_Exceptional_and_Temporary_Contribution
         Rate_AGFF_T1 = (parseFloat(0.800)).toFixed(3),//Rate_Assoc_for_Gest_End_Fund_T1
         Rate_AGFF_T2 = (parseFloat(0.900)).toFixed(3);//Rate_Assoc_for_Gest_End_Fund_T2


        var Rate2_AV_P  = (parseFloat(8.500)).toFixed(3),//Rate2_Capped_pension_insurance
            Rate2_AV_DP = (parseFloat(1.800)).toFixed(3),//Rate2_Deplafonnee_pension_insurance
         Rate2_ARRCO_T1 = (parseFloat(4.650)).toFixed(3),//Rate2_Assoc_Reg_Complementary_Pensions_employees_T1
         Rate2_ARRCO_T2 = (parseFloat(12.150)).toFixed(3),//Rate2_Assoc_Reg_Complementary_Pensions_employees_T2
         Rate2_ARRCO_TB = (parseFloat(12.750)).toFixed(3),//Rate_General_Association_of_Pension_Institutions_Frameworks_TB
         Rate2_ARRCO_TC = (parseFloat(20.190)).toFixed(3),//Rate2_General_Association_of_Pension_Institutions_Frameworks_TC
              Rate2_CET = (parseFloat(0.220)).toFixed(3),//Rate2_Exceptional_and_Temporary_Contribution
          Rate2_AGFF_T1 = (parseFloat(1.200)).toFixed(3),//Rate2_Assoc_for_Gest_End_Fund_T1
          Rate2_AGFF_T2 = (parseFloat(1.300)).toFixed(3);//Rate2_Assoc_for_Gest_End_Fund_T2
        ...
        var response = {
            ...
            'cot_pat_AREG':(parseFloat(base_sal)*parseFloat(Rate2_AREG)/100).toFixed(2),
            'Rate_AEE':Rate_AEE,
            'Rate_AEE2': Rate_AEE2,
